...
export default async function minify(imgBase64: string, kernel: keyof KernelEnum) {
    ...
    return "data:image/webp;base64," + (await imgSharp.flatten({ background: { r: 0, g: 0, b: 0 } }).resize(16, 16, { kernel }).webp({ quality: 100, lossless: true }).toBuffer()).toString("base64");
}